...
<form id="pagerForm" method="post" action="${ctx}/base/role/list.html">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="${ctx}/base/role/new.html" target="dialog" rel="addDialog" title="部门信息新增" mask="true" width="540" height="190"><span>添加</span></a></li>
			<li class="line">line</li>
			<li><a class="delete" href="${ctx}/base/role/delete.html" target="selectedTodo" rel="items" title="确定要删除吗?"><span>批量删除</span></a></li>
		</ul>
	</div>
	<table class="table" width="100%" layoutH="80" rel="roleBox">
		<thead>
			<tr>
		...
		<tbody>
			...
			<tr>
				<td align="center"><input type="checkbox" name="items" value="${entity.roleId}" /></td>
				...
				<td>&nbsp;
					<a class="btnEdit" href="${ctx}/base/role/edit/${entity.roleId}.html" target="dialog" rel="modifyDialog" title="部门信息更新" mask="true" width="540" height="190">修改</a>
				</td>
			</tr>
			</c:forEach>
		</tbody>
