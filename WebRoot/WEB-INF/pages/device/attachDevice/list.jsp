...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<sec:authorize ifAnyGranted="LABEL_SYS_ADMIN,LABEL_SYS_DEPT_ADMIN">
				<li><a class="add" href="${ctx}/attachDevice/addAttachDeviceCount/${deviceId}.php" target="dialog" rel="addDialog" title="外控器添加数量" mask="true" width="500" height="128"><span>添加</span></a></li>
				<li class="line">line</li>
				<li><a class="delete" href="${ctx}/attachDevice/delete.php" target="selectedTodo" rel="items" title="确定要删除吗?"><span>批量删除</span></a></li>
			</sec:authorize>
		</ul>
	</div>
	<table class="table" width="100%" layoutH="76" rel="quotaBox">
		...
		<tbody>
			<c:forEach var="entity" items="${attachDevices}" varStatus="statue">
				<tr>
					<td align="center">
						<input type="checkbox" name="items" value="${entity.attachDeviceId}" />
					</td>
					<td align="center">
					...
					<td>
						<a class="btnEdit"
							href="${ctx}/attachDevice/edit/${entity.attachDeviceId}.php"
							target="dialog" rel="addDialog" title="编辑外控器" mask="true"
							width="800" height="130">编辑</a>
					</td>
				</tr>
			</c:forEach>
		</tbody>
